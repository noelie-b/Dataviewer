...
from resources.auth import InscriptionApi, ConnexionApi
...
with open("./datas/donnees-de-vaccination-par-commune.json", "r") as f:
    data = f.read()
...
def job1():
    ...
    if date < datetime.datetime.now():
        ...
        with open("./datas/donnees-de-vaccination-par-commune.json", "w") as f:
...
api.add_resource(InscriptionApi, '/apidocs/inscription')
api.add_resource(ConnexionApi, '/apidocs/connexion')
